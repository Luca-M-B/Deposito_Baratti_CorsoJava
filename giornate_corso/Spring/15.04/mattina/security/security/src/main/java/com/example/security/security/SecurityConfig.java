...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Pagine pubbliche e risorse statiche accessibili a chiunque
                        .requestMatchers("/", "/login", "/error", "/public/**", "/css/**", "/js/**", "/images/**",
                                "/favicon.ico")
                        .permitAll()
    ...
    /**
     * Definisce il bean AuthenticationManager in modo semplificato per Spring Boot
     * 3.
     */
    @Bean
